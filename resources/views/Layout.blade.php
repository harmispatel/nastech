...
<head>
    ...
    <?php if($panelInit->settingsArray['favicon'] == "e"){ ?>
        <link rel="icon" type="image/png" sizes="16x16" href="{{URL::asset('assets/images/favicon/nastech-favicon.png')}}">
    <?php } ?>
...
<body class="fix-header <?php if($panelInit->settingsArray['leftmenuScroller'] == "e"){ echo "fix-sidebar"; } ?> card-no-border" ng-app="OraSchool" ng-controller="mainController">
    ...
    <div id="main-wrapper">
        ...
        <!-- ============================================================== -->
        <header class="topbar <?php if($panelInit->settingsArray['leftmenuScroller'] == "e"){ echo "topbarSticky"; } ?> no-print topbar-bg">
            <nav class="navbar top-navbar navbar-toggleable-sm navbar-light">
                <!-- ============================================================== -->
                <!-- Logo -->
                <!-- ============================================================== -->
                <div class="navbar-header nastec-head">
                    <a class="navbar-brand nastec-brand" href="#/">
                        <?php
                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav mr-auto mt-md-0 ">
                        <!-- This is  -->
                        <li class="nav-item"> <a class="nav-link nav-toggler hidden-md-up text-muted waves-effect waves-dark topbar-icon" href="javascript:void(0)"><i class="ti-menu"></i></a> </li>
                        <li class="nav-item"> <a class="nav-link sidebartoggler hidden-sm-down text-muted waves-effect waves-dark topbar-icon" href="javascript:void(0)"><i class="icon-arrow-left-circle"></i></a> </li>
                    </ul>
                    <!-- ============================================================== -->
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <?php } ?>
                        <li class="nav-item dropdown" style="width:45px;">
                            <a href="{{URL::to('/logout')}}" class="nav-link text-muted waves-effect waves-dark topbar-icon" > <i class="fa fa-power-off"></i></a>
                        </li>
        ...
        <aside class="left-sidebar <?php if($panelInit->settingsArray['leftmenuScroller'] == "e"){ echo "enableSlimScroller"; }else{ echo "menuTraditional"; if($panelInit->isRTL == 1){ echo " menuTraditionalRTL "; } } ?> no-print" style="padding-bottom:60px;">
            ...
            <div class="scroll-sidebar" >
                <!-- User profile -->
                <div class="user-profile u-pro-bg">
                    <!-- User profile image -->
